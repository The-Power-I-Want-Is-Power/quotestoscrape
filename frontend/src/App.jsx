        ...
        <header className="text-center mb-16 animate-fade-in">
          <div className="relative inline-block">
            ...
            <div className="relative flex items-center gap-4 bg-background-secondary/50 backdrop-blur-sm px-8 py-4 rounded-2xl border border-border/30">
              ...
              <h1 className="text-text-primary font-bold tracking-tight leading-none -mt-1">
          ...
          <p className="text-text-secondary mt-6 text-xl font-light max-w-3xl mx-auto leading-relaxed">
